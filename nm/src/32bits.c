...
/*   Updated: 2024/11/27 13:33:19 by ydumaine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int compare_symbols32(Elf32_Sym *sym1, Elf32_Sym* sym2, char *sym_str_tab, size_t sym_str_tab_size, int is_little_endian)
{
    ...
    uint32_t st_value1 = read_uint32(sym1->st_value, is_little_endian);
    uint32_t st_value2 = read_uint32(sym2->st_value, is_little_endian);
